...
do
{
    sudo ./simple_switch clickp4.json $INTF_S3_1 $INTF_S3_2 $LOG --thrift-port 9092
} &
done
...
do
{
    sudo ./simple_switch clickp4.json $INTF_S4_1 $INTF_S4_2 $LOG --thrift-port 9093
} &
done
...
do
{
    sudo ./simple_switch clickp4.json $INTF_S5_1 $INTF_S5_2 $LOG --thrift-port 9094
} &
done
...
do
{
    sudo ./simple_switch clickp4.json $INTF_S6_1 $INTF_S6_2 $LOG --thrift-port 9095
} &
done
...
do
{
    sudo ./simple_switch clickp4.json $INTF_S7_1 $INTF_S7_2 $LOG --thrift-port 9096
} &
done

sudo ./simple_switch clickp4.json $INTF_S8_1 $INTF_2 $LOG --thrift-port 9097